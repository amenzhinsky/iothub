...
//
// The TrustBundle is generated by the Edge Runtime at startup. The connection
// to the edgeHub (proxy for IoT Hub) requires this cert. This CA cert can be
// pulled from an API exposed on the edge runtime detailed in the below function.
func TrustBundle(workloadUri, apiVersion string) *x509.CertPool {

	// format uri string
	uri := fmt.Sprintf("%strust-bundle?api-version=%s", workloadUri, apiVersion)
