...
func NewFromConnectionString(
	transport transport.Transport, cs string, edge bool, opts ...ClientOption,
) (*Client, error) {
...
func ParseConnectionString(cs string) (*SharedAccessKeyCredentials, error) {
	m, err := common.ParseConnectionString(cs, "DeviceId", "SharedAccessKey", "ModuleId")
	if err != nil {
		return nil, err
	}
